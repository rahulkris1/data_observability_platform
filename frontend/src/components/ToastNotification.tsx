...
function ToastItem({ toast }: { toast: Toast }) {
  ...
  return (
    <div
      className={`flex items-start p-4 mb-3 rounded-lg border shadow-lg transition-all duration-300 ease-in-out ${colorMap[toast.type]}`}
      role="alert"
    >
 ...
 * Displays all active toasts in the top-right corner
 */
